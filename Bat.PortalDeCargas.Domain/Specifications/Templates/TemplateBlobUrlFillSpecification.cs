...
{
    public class TemplateBlobUrlFillSpecification : SyncSpecification<TemplateFormDTO>
    {
        public override bool IsSatisfiedBy(TemplateFormDTO entity) =>
            !string.IsNullOrWhiteSpace(entity.BlobUrl) &&
            Uri.IsWellFormedUriString(entity.BlobUrl, UriKind.RelativeOrAbsolute);
    }
}